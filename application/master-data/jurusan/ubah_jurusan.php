  ...
  <form method="POST" action="?go=data-jurusan">
    <div class="box-body">
      <div class="form-group">
        ...
        <input type="text" name="kode_jurusan" class="form-control" id="examplejurusan/prodi" placeholder="masukan kode jurusan" value="<?= $data['kode_jurusan'] ?>">
      </div>
      <div class="form-group">
        <label for="exampleInputjurusan/prodi">Jurusan/prodi</label>
        <input type="hidden" name="jurusan_lama" value="<?= $data['jurusan'] ?>">
        <input type="text" name="jurusan" class="form-control" id="examplejurusan/prodi" placeholder="masukan jurusan/prodi" value="<?= $data['jurusan'] ?>">
      </div>
      <!-- /.box-body -->
